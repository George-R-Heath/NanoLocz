classdef NanoLocz_v1_00_PreRelease_exported < matlab.apps.AppBase
...
%                         end
            ...
            function loading(app)
                app.stop = 0;
                    ...
                    app.NanoLocz1_00Pre.Pointer = 'watch';
            end

            function finished(app)
                app.stop = 1;
                app.ProcessingImage.Visible = 0;
                app.NanoLocz1_00Pre.Pointer = 'arrow';
            end
        ...
        function storedata(app)
            ...
            if isfield(app.Part,'Locs')
                field4 = 'ImageLocs';  value4 = app.Part.Locs;
            else
    ...
    methods (Access = private)
        ...
        function FilesListBoxValueChanged(app, event)
            ...
            if sum(ch)==1
                ...
                s = any(app.stored(ch).ImageLocs);
                if s(1)~=0
                    app.Part.Locs = app.stored(ch).ImageLocs;
                    filter_Partlocs(app)
                end
  ...
  app.patches.histup = patch(app.Hist_Axes,[app.SliderMax.Limits(2) app.SliderMax.Value app.SliderMax.Value app.SliderMax.Limits(2)], [app.Hist_Axes.YLim(1), app.Hist_Axes.YLim(1),  app.Hist_Axes.YLim(2)  app.Hist_Axes.YLim(2)],...
        ...
        % Double-clicked callback: FilesListBox
        ...
        function PeaksRegionsSwitchValueChanged(app, event)
            ...
            switch app.PeaksRegionsSwitch.Value
                case 'Regions'
                 ...
                 app.AutocenterreferencePanel.Visible = 1;
                 app.AllowrotationofreferencePanel.Visible = 1;
                ...
                case 'Peaks'
                    ...
                    app.AutocenterreferencePanel.Visible = 0;
                    app.AllowrotationofreferencePanel.Visible=0;
            ...
            function dragging_sq(~, ~, ax, type)
                ...
                switch type
                    case 'rectHandle'
                        ...
                        app.ref.image =  imcrop(img(:,:,round(app.FrameSlider.Value)), [p(1), p(2), p(3)-1, p(4)-1]);
                        app.ref.position = p;
...
elseif strcmp(selection, 'Session File')
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.FilesListBox.DoubleClickedFcn = createCallbackFcn(app, @FilesListBoxDoubleClicked, true);
            ...
            % Assign app.ContextMenu_ScaleBar
            app.ScalebarCheckBox.ContextMenu = app.ContextMenu_ScaleBar;
            ...
            % Assign app.ContextMenu_TimeScale
            app.TimescaleCheckBox.ContextMenu = app.ContextMenu_TimeScale;
            ...
            % Assign app.ExportContextMenu
            app.ExportButton.ContextMenu = app.ExportContextMenu;
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = NanoLocz_v1_00_PreRelease_exported
