% Code and method are adapted using the FindSteps.m and PolyfitLineMasked.m scripts
% from SPIW (https://sourceforge.net/projects/spiw/) combined with NanoLocz leveling methods
